...
Wikipedia and simonwillison.net independently confirm that OpenAI's GPT-5.3-Codex and Anthropic's Opus 4.6 were both released on February 5, 2026, within minutes of each other.
...
METR is a real organization that publishes data-based metrics like the 'task-completion time horizon' for AI models, as confirmed by metr.org and Wikipedia.
...
LessWrong and the-decoder report the 4hr49min figure is METR's 50%-success-rate time horizon, and at 80% success the time horizon drops to just 27 minutes, a limitation the claim omits by stating flatly that the AI can complete ~5-hour tasks.
...
METR's own research confirms a ~7 month doubling time, and secondary sources (AI 2027 Tracker, andreaiorio.com) corroborate the claim of acceleration to roughly every 3-4 months.
...
Multiple independent sources report Amodei predicting AI surpassing humans at almost all tasks within roughly 2026-2027 (ITdaily: 'AI smarter than humans as of 2027'; cdotimes: 'surpass human capabilities in almost everything within the next two to three years').

## c07 — SUPPORTED
> GPT-5.3-Codex is our first model that was instrumental in creating itself. The Codex team used early versions to debug its own training, manage its own deployment, and diagnose test results and evaluations.

OpenAI's own announcement states that GPT-5.3-Codex was the first model instrumental in creating itself, with the Codex team using early versions to debug its own training, manage its own deployment, and diagnose test results and evaluations.
...
Sources confirm Amodei said AI is writing 90% of Anthropic's code, a specific figure far more concrete than the vague 'much of the code' phrasing, and none of the snippets mention the 'gathering steam month by month' feedback-loop quote at all.
...
GPT-4, released in March 2023, was documented to pass a simulated bar exam scoring around the top 10% of test takers per OpenAI's GPT-4 Technical Report and confirmed by independent research (SSRN, Royal Society).
