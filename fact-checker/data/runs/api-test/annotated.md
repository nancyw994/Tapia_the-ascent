...
Multiple independent sources (Wikipedia, ucstrategies.com, interconnects.ai, nxcode.io) confirm that GPT-5.3-Codex from OpenAI and Claude Opus 4.6 from Anthropic were both released on February 5, 2026.
...
Multiple independent sources (Forbes, Shawn Kanungo, MindStudio) confirm Dario Amodei predicted AI could eliminate up to 50% of entry-level white-collar jobs within one to five years.
...
Comparator did not explain the verdict from the snippets.
...
METR's data shows the 7-month doubling refers specifically to the '50%-task-completion time horizon' metric, not a general capability number, and the claimed acceleration to 4 months is only weakly supported by a low-tier tracker site rather than robust independent evidence.
...
Multiple independent sources (ITdaily, cdotimes) confirm Amodei predicted AI surpassing humans at most/almost all tasks within the 2026-2027 timeframe.

## c06 — SUPPORTED
> GPT-5.3-Codex is our first model that was instrumental in creating itself. The Codex team used early versions to debug its own training, manage its own deployment, and diagnose test results and evaluations.

OpenAI's official announcement states the Codex team used early versions to debug its own training, manage its own deployment, and diagnose test results and evaluations, matching the claim.
...
Sources confirm Amodei said AI now writes 90% of code at Anthropic, a specific figure far more concrete than the vague "much of the code" phrasing, and none of the snippets support the claim about a feedback loop "gathering steam month by month."
...
Multiple independent sources (nationalsecuritynews.com, LinkedIn, Forbes) confirm Amodei's essay describes powerful AI as potentially "the single most serious national security threat we've faced in a century, possibly ever."
...
## c12 — OPINION
> It would confidently tell you that 7 × 8 = 54.
