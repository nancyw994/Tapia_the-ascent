...
## c01 — SUPPORTED
> on February 5th, two major AI labs released new models on the same day: GPT-5.3 Codex from OpenAI, and Opus 4.6 from Anthropic

Wikipedia and Overchat AI both confirm OpenAI released GPT-5.3-Codex and Anthropic released Claude Opus 4.6 on February 5, 2026, matching the claim's date and models.
...
Multiple independent sources confirm GPT-4 passed the Uniform Bar Exam in March 2023, scoring in the 90th percentile per Stanford Law School's report.

## c04 — MISLEADING
> The most recent measurement (Claude Opus 4.5, from November) showed the AI completing tasks that take a human expert nearly five hours.

The 4h49m figure is METR's 50%-success time horizon (a statistical measure with wide confidence intervals), not a general claim that the AI can complete 'tasks that take a human expert nearly five hours,' so the essay drops the crucial 50%-success-rate qualifier as noted in the-decoder.com and lesswrong.com sources.

## c05 — MISLEADING
> that number is doubling approximately every seven months, with recent data suggesting it may be accelerating to as fast as every four months

METR's doubling metric specifically refers to the 50%-task-completion time horizon (per metr.org and lesswrong.com), not a general capability measure, and the claim omits this critical qualifier while presenting the four-month acceleration as settled fact from a low-tier tracker source.
...
Ars Technica and Forbes report Amodei saying AI could surpass 'almost all humans at almost everything' around 2027, matching the claim's substance and timeframe.

## c07 — SUPPORTED
> GPT-5.3-Codex is our first model that was instrumental in creating itself. The Codex team used early versions to debug its own training, manage its own deployment, and diagnose test results and evaluations.

AICloudIT independently reports the same quote that 'the Codex team used early versions to debug its own training, manage its own deployment, and diagnose test results and evaluations,' corroborating the claim.

## c08 — OPINION
> we may be "only 1–2 years away from a point where the current generation of AI autonomously builds the next."
...
## c10 — OPINION
> I think of my friend, who's a lawyer. I keep telling him to try using AI at his firm, and he keeps finding reasons it won't work.
...
Multiple independent sources (Fortune, National Security News, and Amodei's own essay) confirm he described powerful AI as "the single most serious national security threat we've faced in a century, possibly ever."

## c12 — CONTRADICTED
> He wrote a 20,000-word essay about it last month

The sources attribute the 20,000-word essay to Anthropic CEO Dario Amodei, not to the person referenced in the claim.

## c13 — UNVERIFIABLE
> Anthropic has documented their own AI attempting deception, manipulation, and blackmail in controlled tests.

Fewer than two independent, non-reprint sources.

## c14 — UNVERIFIABLE
> There's an organization called METR that actually measures this with data.
...
Matt Shumer Feb 9, 2026 20 min read@mattshumer_
